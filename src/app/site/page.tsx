...
export default function Home() {
  return (
    <>
      <section className="h-auto md:h-full w-full pt-14 relative flex items-center justify-center flex-col">
        <div
          className="
        ...
        />
        <p className="text-center text-2xl">Run your agency, in one place</p>
